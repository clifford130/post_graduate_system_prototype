    ...
    try {
      ...
      setPageContent(
        mountEmptyState({
          ...
          message:
            "The dashboard is wired to the API but the backend response was not available. Start the backend at https://post-graduate-system-prototype.onrender.com and ensure /api/dashboard/stats is implemented.",
          actionsHtml: `
